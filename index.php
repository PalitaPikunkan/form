    ...
    <div class="container">
        <form action="">
            ...
            <div class="form-group row">
                ...
                <label for="Namefood" class="form-label col-sm-2">Namefood</label>
                <div class="col-md-3">
        ...
        <table class="table table-dark" id="sl4" >
            <thead>
                <tr>
                    <th scope="col">ID</th>
...
<script>
 $(function () {
    ...
    $("#btnupdate").on('click', function () {
        ...
        Namefood = $("#Namefood").val();
        Price = $("#Price").val();
        $("#sl4 tbody tr").eq($('#hfRowIndex').val()).find('td').eq(0).html(ID);
        $("#sl4 tbody tr").eq($('#hfRowIndex').val()).find('td').eq(1).html(Nameshop);
        $("#sl4 tbody tr").eq($('#hfRowIndex').val()).find('td').eq(2).html(Namefood);
        $("#sl4 tbody tr").eq($('#hfRowIndex').val()).find('td').eq(3).html(Price);
        $("#btnadd").show();
        $("#btnupdate").hide();
        Clear();
    });
   
        $("#sl4").on("click", ".delete", function (e) {
